...
import com.TechConnecGrupo3.TechConnecapi.exception.CustomErrorResponse;
...
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    // Metodo auxiliar para convertir el objeto de error en un JSON para incluirlo en la respuesta HTTP
